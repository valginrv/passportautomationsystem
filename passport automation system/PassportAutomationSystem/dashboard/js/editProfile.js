...
function updateUserProfileDetails() {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://localhost/pas_backend/updateDetails.php", true);
    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhttp.setRequestHeader('Cache-Control', 'no-cache');
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
    ...
    if (newPasswordValue == "" || confirmNewPasswordValue == "" || currentPasswordValue == "") {
        ...
        if (newPasswordValue == confirmNewPasswordValue) {
            ...
            if (newPasswordValue != currentPasswordValue) {
                ...
                var xhttp = new XMLHttpRequest();
                xhttp.open("POST", "http://localhost/pas_backend/validatePassword.php", true);
                xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xhttp.setRequestHeader('Cache-Control', 'no-cache');
                xhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
...
function updateUserPassword(password) {
    ...
    $(".signon-loader-container").css('display', 'initial');
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://localhost/pas_backend/updatePassword.php", true);
    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhttp.setRequestHeader('Cache-Control', 'no-cache');
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
