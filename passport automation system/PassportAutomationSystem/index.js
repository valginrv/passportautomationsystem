...
function showConfirmation(event) {
    ...
    try {
        ...
        xhttp.open("POST", "http://localhost/pas_backend/forgotPassword.php", true);
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (result == 'success') {
                    ...
                    $("#resetPasswordButton").fadeOut(function() {
                        $("#emailConfirmationButton").fadeIn();
                        $("#emailConfirmationText").fadeIn();
                    });
        ...
        xhttp.send("role=applicant&emailID=" + resetEmail.value);
    } catch {
        $(".signon-button-text").show();
        $(".signon-loader-container").hide();
        $(".signon-button").removeAttr("disabled");
...
function onSignUp(event) {
    ...
    $(".signon-loader-container").css('display', 'inline-block');
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://localhost/pas_backend/signUp.php", true);
    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhttp.setRequestHeader('Cache-Control', 'no-cache');
...
function validateEmail(event) {
    ...
    var xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://localhost/pas_backend/authenticate.php", true);
    xhttp.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
    xhttp.setRequestHeader('Cache-Control', 'no-cache');
